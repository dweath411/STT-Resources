...
#Syntax is dataset "." field, no dollar sign. Also uses single =, not ==.
#Remember, SELECT * pulls everything from both databases / data frames
#Don't use WHERE for huge data sets. Use ON for bigger sets.
